          ...
          <div className="pointer-events-auto mx-auto flex w-full max-w-[1400px] items-start px-6 pt-28 md:px-12 md:pt-36 lg:px-14">
            <div className="max-w-md">
              <h1 className="font-display text-[36px] leading-[0.95] tracking-tight text-ink sm:text-[44px] md:text-[58px] lg:text-[68px]">
                Pizza wie in
                <br />
                <span className="italic text-rosso-600">Bella Italia.</span>
              </h1>
              <p className="mt-5 max-w-sm text-[15px] leading-relaxed text-ink/70 md:text-[16px]">
                72 Stunden Teigreife, Caputo-Mehl, Fior di Latte. Frisch
                belegt in der Mannheimer Straße, fertig zum Mitnehmen oder
                Liefern.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-3 md:mt-8 md:gap-4">
                ...
                <a
                  href="#menu"
                  className="inline-flex items-center justify-center rounded-full border border-ink/20 bg-bone/70 px-7 py-3 text-[13px] font-medium tracking-wide text-ink backdrop-blur-sm transition-colors hover:bg-bone/85"
                >
                  Speisekarte
                </a>
              </div>
