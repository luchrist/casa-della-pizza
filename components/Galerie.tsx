...
const fallbackImages = [
  { src: "/galerie/01.jpg", alt: "Innenraum mit warmem Licht und offener Küche" },
  { src: "/galerie/02.jpg", alt: "Margherita frisch aus dem Holzofen" },
  { src: "/galerie/03.jpg", alt: "Handgemachte Tagliatelle auf dem Holzbrett" },
  { src: "/galerie/04.jpg", alt: "Gedeckter Tisch mit Weingläsern" },
  { src: "/galerie/05.jpg", alt: "Tiramisu della Casa" },
];
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-9">
            <h2 className="font-display text-[40px] leading-[1.02] tracking-tight text-ink md:text-[64px] lg:text-[78px]">
              Direkt aus
              <br />
              dem <span className="italic text-basilico-700">Karton.</span>
            </h2>
          </div>
        </div>
