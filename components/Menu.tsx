        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-9">
            <h2 className="font-display text-[40px] leading-[1.02] tracking-tight md:text-[64px] lg:text-[78px]">
              Klassiker.
              <span className="italic text-rosso-300"> Speciali.</span>
              <br />
              Auf Bestellung.
            </h2>
            <p className="mt-6 max-w-[58ch] text-[15px] leading-relaxed text-bone/60">
              Eine Auswahl aus dem, was bei uns auf den Teig kommt. Aktuelle
              Preise und die volle Karte erfährst du telefonisch oder am
              Tresen in der Mannheimer Straße.
            </p>
          </div>
        </div>
